...
namespace TestProyect.Migrations
{
    ...
    [Migration("20211214213239_ActualizacionEquipos")]
    partial class ActualizacionEquipos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestProyect.Models.Componentes", b =>
                {
                    ...
                    b.Property<int?>("EntrenadorCompId")
                        .IsRequired()
                        .HasColumnType("int");

                    b.Property<string>("IconoComponente")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TestProyect.Models.Mesociclos", b =>
                {
                    b.Property<int>("IdMesociclo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<DateTime>("FechaMesococlo")
                        .HasColumnType("datetime2");

                    b.Property<int?>("MesocicloCanId")
                        .IsRequired()
                        .HasColumnType("int");

                    b.Property<int?>("MesocicloCompId")
                        .HasColumnType("int");

                    b.Property<int?>("MesocicloEquId")
                        .HasColumnType("int");

                    b.Property<string>("ObservacionesMesococlo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("TurnoMesococlo")
                        .HasColumnType("int");

                    b.Property<int>("VolumenMesociclo")
                        .HasColumnType("int");

                    b.HasKey("IdMesociclo");

                    b.HasIndex("MesocicloCanId");

                    b.HasIndex("MesocicloCompId");

                    b.HasIndex("MesocicloEquId");

                    b.ToTable("Mesociclos");
                });
            ...
            modelBuilder.Entity("TestProyect.Models.Subcomponentes", b =>
                {
                    b.Property<int>("IdSubcomponente")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("ComponenteSubId")
                        .IsRequired()
                        .HasColumnType("int");

                    b.Property<string>("NombreSubcomponente")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("IdSubcomponente");

                    b.HasIndex("ComponenteSubId");

                    b.ToTable("Subcomponentes");
                });
            ...
            modelBuilder.Entity("TestProyect.Models.Componentes", b =>
                {
                    b.HasOne("TestProyect.Models.Entrenadores", "Entrenadores")
                        .WithMany()
                        .HasForeignKey("EntrenadorCompId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TestProyect.Models.Mesociclos", b =>
                {
                    b.HasOne("TestProyect.Models.Canchas", "Canchas")
                        .WithMany()
                        .HasForeignKey("MesocicloCanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TestProyect.Models.Componentes", "Componentes")
                        .WithMany()
                        .HasForeignKey("MesocicloCompId");

                    b.HasOne("TestProyect.Models.Equipos", "Equipos")
                        .WithMany()
                        .HasForeignKey("MesocicloEquId");
